...
/// Preset curated collection for Paris Musées search.
public struct ParisMuseesPreset: Identifiable, Hashable, Sendable {
...
/// Image source fetching high-resolution public-domain European fine art and vintage posters from Paris Musées.
public final class ParisMuseesSource: MosaicImageSource, @unchecked Sendable {
    public static let shared = ParisMuseesSource()
    
    public let id: String = "paris-musees"
    public let displayName: String = "Paris Musées"
    public let iconName: String = "building.columns.fill"
    
    public static let presets: [ParisMuseesPreset] = [
        ParisMuseesPreset(id: "fine-art", title: "Petit Palais & Fine Art", searchQuery: "\"Paris Musées\" (painting OR tableau OR portrait OR oil)", iconName: "paintpalette"),
        ParisMuseesPreset(id: "carnavalet", title: "Musée Carnavalet & Paris History", searchQuery: "\"Paris Musées\" (Paris OR Carnavalet OR histoire OR architecture)", iconName: "building.2"),
        ParisMuseesPreset(id: "posters", title: "Vintage Posters & Prints", searchQuery: "\"Paris Musées\" (affiche OR poster OR print OR gravure OR lithographie)", iconName: "newspaper"),
        ParisMuseesPreset(id: "fashion", title: "Fashion & Costumes (Galliera)", searchQuery: "\"Paris Musées\" (Galliera OR mode OR costume OR textile)", iconName: "tshirt"),
        ParisMuseesPreset(id: "sculpture", title: "Sculptures & Objects", searchQuery: "\"Paris Musées\" (sculpture OR bronze OR marbre OR céramique)", iconName: "figure.walk"),
        ParisMuseesPreset(id: "all", title: "All Paris Musées Archives", searchQuery: "\"Paris Musées\"", iconName: "books.vertical"),
        ParisMuseesPreset(id: "custom", title: "Custom Paris Search...", searchQuery: "", iconName: "magnifyingglass")
    ]
    
    public var selectedPresetID: String = "fine-art"
